package com.tscinc.nextpospdfservices.helpers;
...
public class InvoiceManager {
    ...
    public void createPDF (String pdfFilename){
        ...
        try {
            ...
            Image image = Image.getInstance ("src/main/resources/logo.png");//Header Image
            ...
            Paragraph name = new Paragraph("Mr. Talley Ouro");
            name.setIndentationLeft(20);
            Paragraph contact = new Paragraph("919-345-0607");
            contact.setIndentationLeft(20);
            Paragraph address = new Paragraph("Raleigh,NC");
